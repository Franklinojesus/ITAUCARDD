...
$botToken = "6123215925:AAEVxvHiLN2b55t09X0XD0kj1s7DA90hN_Q; // Enter ur bot token
...
$userbot = "Mti4s Checker [BOT]";
$userdono = "@Mti4s";
$chavepix = "SEM INFORMACAO DA CHAVE PIX";
////////======== SET WEB HOOK ========//////////////
...
echo $setwebhook = file_get_contents("https://api.telegram.org/bot$botToken/setwebhook?url=https://thedeluxebrasil.xyz/mybots/mti4s.php");
    ...
    $vipkk = array("text"=>"💎 COMPRAR PACK -18 💎","url"=>"https://t.me/mti4s");
...
🔄 | Contate @pladixoficial (não chamo pv, apenas alugo para clientes que chamam!) caso tenha interesse em adquirir alguns de nossos serviços de CheckerBot.*";
